...
const ManaulScriptDetails = (props: IProps) => {
  ...
  const on_execute = async () => {
    ...
    await FileScripts.execute_manual_script_on_all(props.script);
  };
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: "20px" }}>
        <p>Execute manual script '{props.script.name}', on all associated media</p>
...
export default observer(ManaulScriptDetails);
